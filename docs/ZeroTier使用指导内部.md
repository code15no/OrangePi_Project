...
> 这个网络ID在本任务中并没有用，但是你可以通过你的个人VLAN管理自己的设备。
...
请将此网络ID粘贴到你的ZeroTier客户端中：```DB64858FED12AAF4```

粘贴后请将你的设备地址告诉我，我会给你授权。

或者，你也可以通过扫描如下二维码来尝试加入这一网络。如果这些都有问题，请联系我，我会尝试给你的邮箱发送邀请邮件，你可以尝试通过邀请链接加入本网络。

![image-20250801225616331](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20250801225616331.png)
...
> 现在我们默认都使用`HwHiAiUser`这一用户，之后我会考虑尝试给大家都建立个人用户，这样不容易冲突。不过考虑到 板子的配置简陋，其实或许使用一个用户就够了？
